...
import com.nta.lc_server.ui.category.CategoryViewModel;
    ...
    private void initViews() {
        ...
        MySwipeHelper mySwipeHelper = new MySwipeHelper(getContext(), recycler_food_list, width / 6) {
            ...
            public void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buf) {
                ...
                //Button Delete
                buf.add(new MyButton(getContext(), "Delete", 35, 0, Color.parseColor("#9b0000"),
                        pos -> {
                            if (foodModelList != null)
                                Common.selectedFood = foodModelList.get(pos);
                            AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                            builder.setTitle("DELETE")
                                    .setMessage("Do you want delete this food?")
                ...
                //Button Addon
                buf.add(new MyButton(getContext(), "Addon", 35, 0, Color.parseColor("#336699"),
                        pos -> {
                            FoodModel foodModel = adapter.getItemAtPosition(pos);
                            if (foodModel.getPositionInList() == -1)
                                Common.selectedFood = foodModelList.get(pos);
